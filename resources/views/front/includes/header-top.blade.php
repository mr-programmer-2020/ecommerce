    ...
    <div class="container">
        <div class="content">
            <div class="row">
                ...
                >
                    <div
                        class="detail-email d-flex align-items-center justify-content-center"
                    >
                    ...
                    <div
                        class="detail-call d-flex align-items-center justify-content-center"
                    >
                        <i class="icon-deal"></i>
                        <p>Today Deals</p>
                    </div>
                            ...
                            <div class="currency-list-content text-left">
                                ...
                                <div class="currency-item">
                                    <a
                                        title="دولار أمريكي"
                                        rel="nofollow"
                                        href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2"
                                        >US$ USD</a
                                    >
                                </div>
                            </div>

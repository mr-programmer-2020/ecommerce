<div class="header-center hidden-sm-down">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div
                class="col-lg-9 col-md-9 header-menu d-flex align-items-center justify-content-end"
            >
                <div class="data-contact d-flex align-items-center">
                    <div class="title-icon">
                        support<i class="icon-support icon-address"></i>
                    </div>
                ...
                <div class="contentsticky_group d-flex justify-content-end">
                    ...
                    <div class="header_link_wishlist">
                        <a
                            href="http://demo.bestprestashoptheme.com/savemart/ar/module/novblockwishlist/mywishlist"
                            title="My Wishlists"
                        >
                    ...
                    <div id="_desktop_cart">
                        <div
                            class="blockcart cart-preview active"
                        ...
                        >
                            <div class="header-cart">
                                ...
                                <div
                                    class="cart-right d-flex flex-column align-self-end ml-13"
                                >
